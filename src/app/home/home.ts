...
@Component({
  ...
  template: `
    <div class="home-page">
      <div class="home-hero">
        <svg class="hero-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
      ...
      <div class="card-grid">
        <a routerLink="/incident/dashboard" class="nav-card nav-card-blue">
          ...
          <div class="nav-card-body">
            ...
            <div class="nav-card-desc">ติดตามการรับแจ้งเหตุแบบเรียลไทม์ บันทึกเหตุ และกำหนดเจ้าหน้าที่ประจำเวร</div>
          </div>
          <svg class="nav-card-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
  ...
  styles: [`
    ...
    .nav-card-blue:hover .nav-card-arrow { color: #00B4D8; }
    ...
    .nav-card-purple:hover .nav-card-arrow { color: #9D4EDD; }
    ...
    .nav-card-yellow:hover .nav-card-arrow { color: #FFB703; }
    ...
    .nav-card-green:hover .nav-card-arrow { color: #06D6A0; }
  `],
})
export class Home {}
