...
@Component({
  ...
  template: `
    <div class="placeholder-page">
      ...
      <h1 class="placeholder-title">สรุปผลรายงานรับแจ้งเหตุ</h1>
  ...
  styles: [`
    ...
    .placeholder-badge {
      ...
      text-transform: uppercase; background: rgba(157, 78, 221, 0.1); color: #9D4EDD;
      border: 1px solid rgba(157, 78, 221, 0.3); border-radius: 20px; padding: 0.2rem 0.75rem;
      margin: 0 0 0.75rem;
    }
